      ...
      <div>
        <Form horizontal form={this.props.form}>
          <Row>
            <Col span="18">
              <FormItem
                ...
                label="账号:"
              >
                <Input {...passProps} type="telephone"
          ...
          <Row>
            <Col span="18">
              <FormItem
                ...
                label="新管理账号:"
              >
                <Input {...rePassProps} type="telephone"
                       onContextMenu={noop} onPaste={noop} onCopy={noop} onCut={noop}
          ...
          <Row>
            ...
            <Col span="6">
              <Button type="primary" onClick={this._beginCountDown} size={"small"} ghost>{ this.state.begin === 0 ? '获取验证码' : this.state.timeLeft}</Button>
              {this.state.rePassBarShow ? this.renderPassStrengthBar('re_new_Pass') : null}
            </Col>
          </Row>
          <Row>
