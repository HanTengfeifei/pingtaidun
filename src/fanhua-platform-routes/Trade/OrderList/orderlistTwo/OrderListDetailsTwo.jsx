...
import BasicMessageTwo from './BasicMessageTwo' ;
import OrderListDetailsAddrTableThree from '../OrderListDetailsAddrTableTwo' ;
import OrderListDetailsYunTablethree from '../OrderListDetailsYunTablethree' ;
import OrderListDetailsSumTableThree from './OrderListDetailsSumTableTwo' ;
    ...
    addstr = <div>
                ...
                <Row gutter={8} style={{ marginTop: '10px' }}>
                  <Col span={8}>
                    ...
                    <TextArea style={{marginBottom:'10px'}} autosize={{ minRows: 6, maxRows: 15 }} onChange={(e) => messageChange.bind(this)(e.target.value)}/>
    ...
    return (
      <div >
        <Card hoverable title="查看订单详情" type="card">
          ...
          <Row gutter={8} style={{ marginTop: '10px' }}>
            <Col>
              <BasicMessageTwo order={order} _pmyself={this} go={this.fetch}></BasicMessageTwo>
            </Col>
          </Row>
          <Divider></Divider>
          {myaddress}
