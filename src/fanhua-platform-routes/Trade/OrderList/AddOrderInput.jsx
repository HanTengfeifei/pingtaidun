    ...
    return (
      <div>
        ...
        <Row gutter={8}>
          ...
          <Col span={6}>
            ...
            <Select dropdownMatchSelectWidth={true} style={{ width: "100%"}}
                    ...
                    defaultValue={this.props.company_all.id}
            >
              <Option value={this.props.company_all.id}>{this.props.company_all.company_name}</Option>
            </Select>
          </Col>
        </Row>
        <Row gutter={8}>
        ...
        <Row gutter={8}>
          ...
          <Col span={6}>
            卖方联系人
            <Input type="text" value={this.props.contact_name} onChange={(e) => this.valueChange('buyer_id', e.target.value)}/>
          </Col>
          <Col span={2}></Col>
          <Col span={6}>
          </Col>
        ...
        <Row>
          <DynamicIput   countAll={this.props.countAll} father={this} sentparents={this.callback}  addr_select_all={this.state.addr_select_all}/>
        </Row>
      </div>
    )
  }
