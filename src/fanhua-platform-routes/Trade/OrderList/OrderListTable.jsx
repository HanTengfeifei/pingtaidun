...
class OrderListTable extends React.Component {
  ...
  fetch(params = {}) {
    getTableData.bind(this)('order/order-list',{order_status:this.props.order_status,kind:1})
  }
  componentDidMount() {
    this.fetch();
  }
  ...
  componentWillReceiveProps(nextProps){
    getTableData.bind(this)('order/order-list',{order_status:nextProps.order_status});
  }
