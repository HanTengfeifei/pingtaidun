...
import OrderListYundanChildrenTd from './OrderListcgYundanChildrenTd' ;
import {RequireUtils} from 'utils';
import createHistory from 'history/createHashHistory';
import OrderListYundanTd from './OrderListcgYundanTd' ;
...
class OrderListYundanTable extends React.Component {
  ...
  render() {
    ...
    const columns = [{
      ...
      key: 'order',
      render: (text, record) => (
        <OrderListYundanTd item={record} pyundan={this} tableExpand={tableExpand}></OrderListYundanTd>
      )
    }];
